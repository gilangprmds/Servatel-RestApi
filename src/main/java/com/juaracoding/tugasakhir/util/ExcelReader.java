...
Java Developer
Created on 11/02/2025 14:34
@Last Modified 11/02/2025 14:34
Version 1.0
*/
...
//	public static final String TYPE = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
    ...
    public ExcelReader(InputStream inputStream, String sheetName) {
        try {
            ...
            LoggingFile.logException("ExcelReader","ExcelReader(InputStream inputStream, String sheetName) --> Line 46",e, OtherConfig.getEnableLogFile());
        }
        finally {
            try {
                inputBuff.close();
                ...
                LoggingFile.logException("ExcelReader","ExcelReader(InputStream inputStream, String sheetName) --> Line 53",e, OtherConfig.getEnableLogFile());
            }
        }
    }
    ...
    public ExcelReader(String excelPath, String sheetName) {
        try {
            ...
            LoggingFile.logException("ExcelReader","ExcelReader(String excelPath, String sheetName) --> Line 64",e, OtherConfig.getEnableLogFile());
        }
        finally {
            try {
                excelFile.close();
                ...
                LoggingFile.logException("ExcelReader","ExcelReader(String excelPath, String sheetName) --> Line 72",e, OtherConfig.getEnableLogFile());
            }
        }
    }
